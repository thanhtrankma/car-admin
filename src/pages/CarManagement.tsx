...
const mapProductToCar = (product: ProductDto): Car => ({
  ...
  status:
    WAREHOUSE_STATUS_META[product.warehouseStatus]?.label ??
    `Trạng thái ${product.warehouseStatus}`,
  ...
  const columns: ColumnsType<Car> = [
    ...
    },
    {
      ...
      render: (status, record) => {
        const meta = record.warehouseStatus
          ? WAREHOUSE_STATUS_META[record.warehouseStatus]
          : undefined
